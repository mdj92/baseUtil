...
import com.dj.basemoudle.bean.UpdateInfo;
import com.dj.basemoudle.config.BaseModuleConfig;
import com.dj.basemoudle.http.JsonCallback;
import com.dj.basemoudle.update.DownLoadService;
...
public class MUpdate {
    ...
    private void checkPermission(final UpdateInfo info) {
        if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.M){
            ...
            MPermissions.getInstance().request((Activity) mContext, permission, new MPermissions.PermissionListener() {
                @Override
